          ...
          <ec:table items="sellBillList" var="sr"
				...
				<ec:row>
					...
					<ec:column property="_0" title="动作" width="11%" style="text-align:center">
						<a style="color:blue;text-decoration:underline;" href="${pageContext.request.contextPath}/admin/finance/finance_showAddFinance.html?sellBill.sbId=${sr.BILLID}">付&nbsp;款</a>
					</ec:column>
				</ec:row>
			</ec:table>
		</div>
