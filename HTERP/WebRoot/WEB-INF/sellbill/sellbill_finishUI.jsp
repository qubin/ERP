...
<script type="text/javascript">
	...
	j(document).ready(function(){
		j("#finishBtn").bind("click",function(){
			if(confirm("确定是否结单")){
				var sbId = j("#sbId").val();
	...
	<div id="container" class="container">
		...
		<input type="hidden" name="sdNum" value="" id="sdNum"/>
			...
			<div align="center" style="margin-top:20px;">
				<h2 align="center">结单备注</h2>
				<textarea name="sb.remark" id="" cols="50" rows="30" class="u-ipt" style="width:320px;height:120px;"></textarea>
			</div>
			<div align="center" style="margin-top:50px;">
			<input class="u-btn" type="button" value="结单" id="finishBtn" />
