...
<body>
    <div id="container" class="container">
      <div class="hr10"></div>
          <div class="hr10"></div>
          <h2>审核订单查询</h2>
		 <form id="form1" action="${pageContext.request.contextPath}/admin/sellbill/sellbill_findExam.html" method="post">
          ...
          <ec:table items="list" var="sr"
				...
				action="${pageContext.request.contextPath}/admin/sellbill/sellbill_examine.html"
				rowsDisplayed='12' 
