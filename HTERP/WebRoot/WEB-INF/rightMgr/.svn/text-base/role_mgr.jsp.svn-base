    ...
    <div id="container" class="container">
      <div class="hr10"></div>
		 ...
		 <form id="form1" action="${pageContext.request.contextPath}/admin/basic/role_find.html" method="post">
             ...
             <tbody>
                <tr>
                  ...
                  <td>
                     ...
                     <button type="button" class="u-btn" onclick="javascript:window.location='${pageContext.request.contextPath}/admin/basic/addRole.html'">新增</button>&emsp;           
                   </td>                 
                </tr>                				                           
             </tbody>
          </table>
          ...
          <h2>角色信息列表</h2> 
          <div align="center">
		   <ec:table items="roleList" var="role1"
				...
				<ec:row>
					...
					<ec:column property="MAX_MINS_MONEY" title="优惠限额" width="10%" />
					...
					<ec:column property="_0" title="动作" width="10%" >
						<a href="${pageContext.request.contextPath}/admin/basic/role_showModifyPage.html?role.roleUuid=${role1.ROLE_UUID}">修 改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/admin/basic/role_authUI.html?role.roleUuid=${role1.ROLE_UUID}">授 权</a>
					</ec:column>
				</ec:row>
			</ec:table>
		</div>
