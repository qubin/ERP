    ...
    <form id="form1" action="${pageContext.request.contextPath }/admin/basic/role_add.html" method="post">    
      <table class="m-table-form">
         <tbody>
         	<tr>
              <th class="tr">角色编号：</th>
              <td><input type="text" class="u-ipt required validate-number" id="1" name="role.roleId" maxlength="10"><font color="red">*</font></td>
            </tr>
            <tr>  
              <th class="tr">角色名称：</th>
            ...
            <tr>  
              ...
              <td><input type="text" class="u-ipt validate-currency-dollar" id="3" name="role.maxMinsMoney" maxlength="6"><font color="red">*</font>元</td>                                   
            </tr>                       
            <tr>  
              <th class="tr">备注：</th>
