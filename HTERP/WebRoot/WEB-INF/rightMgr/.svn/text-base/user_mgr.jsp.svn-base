             ...
             <tbody>
                <tr>
                  ...
                  <td>
                     ...
                     <button type="button" class="u-btn" onclick="javascript:window.location='${pageContext.request.contextPath}/admin/basic/userAddUI.html'">新增</button>&emsp;           
                   </td>                 
                </tr>                				                           
             </tbody>
           </form>  
          ...
          <div align="center">
		   <ec:table items="userList" var="user1"
				...
				<ec:row>
					...
					<ec:column property="CONTACT_PHONE" title="联系电话" width="10%" />
