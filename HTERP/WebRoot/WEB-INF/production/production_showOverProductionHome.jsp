          ...
          <ec:table items="sczldList" var="sr"
				...
				<ec:row>
					...
					<ec:column property="_0" title="动作" width="11%" style="text-align:center">
						<a style="color:blue;text-decoration:underline;" href="${pageContext.request.contextPath}/admin/production/production_showOverProduction.html?pdceistct.uuid=${sr.ID}">详&nbsp;&nbsp;情</a>
					</ec:column>
				</ec:row>
			</ec:table>
		</div>
