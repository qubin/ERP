...
jQuery(function() {
    ...
    $('#sidebar-toggler').toggle(function(){
        homelayout.layout('setSidebar',{region:'west',value:48});
        $(this).parent().width(48);
        homelayout.addClass("isMiniLayout");
        $('#sidebar').addClass("isCollapse");
        $(this).addClass("collapse");
        $('#timedate').hide();
        $('.mini-user-info,.mini-profile-options').hide();
        ...
        if($('#sidebar').hasClass('isCollapse')) {
            ...
            subNavLink.hover(function(){
                ...
                nmUL.css({left:pos.x-5+"px",top:pos.y-42+"px"});
        ...
        homelayout.layout('setSidebar',{region:'west',value:210});
    ...
    subNavLink.on('click',function(event){
        ...
        if(!$('#sidebar').hasClass('isCollapse')) {
            ...
            var navHeight = navlist.outerHeight()+72;
            var navwpHeight = navwp.height()-20;
    ...
    $(window).resize(function(){
        homelayout.layout('setMainNav',{region:'west'});
        //homelayout.layout('setRegionSize',{region:'west'});
    });
    ...
    $(document).on('click',function() {
        $('.sidebar-quickmenu').find('ul').hide();
        $('.mini-profile-options').hide();
        $('.mini-user-info').find('i').addClass("icon-caret-up").removeClass('icon-caret-down');
    });

    $('.sidebar-quickmenu,.mini-profile-options').on('click',function(event) {
        event.stopPropagation();
    });

    //
    if($('.sidebar-quickmenu')[0]){
        $('.sidebar-quickmenu h2').on('click',function(){
            $(this).next('ul').slideToggle();
        });
        $('.sidebar-quickmenu ul li').on('click',function(){
